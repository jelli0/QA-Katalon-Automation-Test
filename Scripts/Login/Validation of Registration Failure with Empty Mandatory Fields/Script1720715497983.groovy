...
WebUI.setText(findTestObject('Login/input_Username_loginusername'), 'InvalidUsernameQA')

WebUI.clearText(findTestObject('Login/input_Password_loginpassword'))
...
WebUI.click(findTestObject('Login/span_'))
